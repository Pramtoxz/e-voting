    ...
    <div class="error-container">
        <div class="error-header">
            ...
            <div class="error-message">
                Mohon maaf, kami mengalami masalah teknis. Tim kami sedang bekerja untuk memperbaikinya.
            </div>
            <div class="error-quote">
                "Kesabaran adalah kunci keberhasilan. Kesabaran mencerminkan ketabahan dan kegigihan seseorang dalam menghadapi tantangan"
            </div>
        </div>

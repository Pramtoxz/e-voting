...
<body>
    <div class="error-container">
        <div class="error-header">
            ...
            <div class="error-title">Waduh, Nyasar Kemana Nih?</div>
            <div class="error-message">
                Ups! Sepertinya halaman yang Anda cari sudah kabur entah kemana. Mungkin dia sedang liburan, atau mungkin memang nggak pernah ada dari sananya. Mari kita cari jalan pulang sama-sama!
            </div>

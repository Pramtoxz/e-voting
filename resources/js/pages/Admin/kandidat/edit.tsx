...
export default function Edit({ kandidat }: Props) {
    ...
    const form = useForm<FormData>({
        ...
        nomor_bp_presiden: kandidat.nomor_bp_presiden,
        nomor_bp_wakil: kandidat.nomor_bp_wakil,
        prodi_presiden: kandidat.prodi_presiden,
        prodi_wakil: kandidat.prodi_wakil,
        foto_presiden: null,
        foto_wakil: null,
        foto_presiden_preview: kandidat.foto_presiden ? `/storage/${kandidat.foto_presiden}` : null,
        foto_wakil_preview: kandidat.foto_wakil ? `/storage/${kandidat.foto_wakil}` : null,
    ...
    function onSubmit(e: React.FormEvent) {
        ...
        formData.append('nama_wakil', form.data.nama_wakil);
        formData.append('nomor_bp_presiden', form.data.nomor_bp_presiden);
        formData.append('nomor_bp_wakil', form.data.nomor_bp_wakil);
        formData.append('prodi_presiden', form.data.prodi_presiden);
        formData.append('prodi_wakil', form.data.prodi_wakil);
        ...
        if (form.data.foto_wakil instanceof File) {
            formData.append('foto_wakil', form.data.foto_wakil);
        }

...
import { AlertTriangle, Camera, CheckCircle, ChevronLeft, ChevronRight, Info, RefreshCcw, Shield, Smile, User, Vote, X } from 'lucide-react';
...
export default function Index({ kandidat, auth }: IndexProps) {
    ...
    const drawHeart = (context: CanvasRenderingContext2D, x: number, y: number, size: number) => {
        ...
        // Bottom left curve
        context.bezierCurveTo(x - size / 2, y + size / 2, x, y + size, x, y + size);

        // Bottom right curve
        context.bezierCurveTo(x, y + size, x + size / 2, y + size / 2, x + size / 2, y + size / 4);
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="mt-2 mb-4 grid grid-cols-2 gap-2">
                                                <div>
                                                    ...
                                                    <p className="text-muted-foreground text-xs">{calon.nomor_bp_presiden}</p>
                                                </div>
                                                <div>
                                                    <p className="text-sm font-semibold">{calon.nama_wakil}</p>
                                                    <p className="text-muted-foreground text-xs">{calon.nomor_bp_wakil}</p>
                                                </div>
                                            </div>
                                            <p className="mb-4 line-clamp-2 text-sm italic">{calon.visi}</p>
                                            <Button
                                ...
                                {selectedKandidat && (
                                    <div className="mb-6 rounded-lg border border-gray-100 bg-gray-50 p-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h3 className="text-lg font-bold text-red-700">{selectedKandidat.nama}</h3>
                                                <p className="text-sm text-gray-600">
                                ...
                                <div className="mt-4">
                                    ...
                                    {!previewImage ? (
                                        <div className="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-6 text-center">
                                            <Button className="bg-red-600 px-4 py-3 text-white hover:bg-red-700" onClick={openCameraModal}>
                                        ...
                                        <div className="rounded-lg border-2 border-gray-300 p-3">
                                            <div className="relative mb-3 max-h-64 w-full overflow-hidden rounded-lg">
                        ...
                        <div className="bg-opacity-75 fixed inset-0 z-50 flex items-center justify-center bg-black">
                            <div className="camera-modal-content relative max-h-[90vh] w-full max-w-3xl overflow-auto rounded-lg bg-white">
                                <div className="flex items-center justify-between border-b border-gray-200 p-4">
                                    ...
                                    <button onClick={closeCameraModal} className="rounded-full p-1 transition-colors hover:bg-gray-200">
                                ...
                                <div className="p-4">
                                    ...
                                    {cameraActive && (
                                        <div className="camera-container mb-4" ref={cameraContainerRef}>
                                                        ...
                                                        <div
                                                            className={`text-6xl font-bold text-white ${
                                                                countdownStyle === 'bubble'
                                                                    ? 'flex h-24 w-24 animate-pulse items-center justify-center rounded-full bg-red-600'
                                                                    : countdownStyle === 'flip'
                                                                      ? 'animate-flip transform bg-transparent'
                                                                      : 'flex h-24 w-24 animate-bounce items-center justify-center rounded-full bg-red-600'
                                                            }`}
                                                        >
                                                            {countDown}
                                                        </div>
                                            ...
                                            {/* Selfi Actions */}
                                            <div className="mb-3">
                                                <p className="mb-2 text-sm font-medium text-gray-700">Ekspresi Selfi:</p>
                                                <div className="flex flex-wrap justify-center gap-2">
                                                    <button
                                                        onClick={() => setSelfiAction('normal')}
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            selfiAction === 'normal' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        Normal
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            selfiAction === 'peace' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        Peace ✌️
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            selfiAction === 'tongue' ? 'bg-orange-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        Lidah 😜
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            selfiAction === 'wink' ? 'bg-green-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        Kedip 😉
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            selfiAction === 'love' ? 'bg-pink-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        Love 💕
                                                    </button>
                                            ...
                                            <div className="mb-3">
                                                <div className="mb-2 flex items-center">
                                                    ...
                                                    />
                                                    <label htmlFor="useSticker" className="text-sm font-medium text-gray-700">
                                                        Tambahkan Stiker
                                                    </label>
                                                </div>
                                                    ...
                                                    <div className="flex justify-start gap-3 pl-6">
                                                        <button
                                                            ...
                                                            className={`flex h-8 w-8 items-center justify-center rounded-full ${
                                                                selectedSticker === 'heart' ? 'border-2 border-red-500 bg-red-100' : 'bg-gray-100'
                                                            }`}
                                                        >
                                                            ❤️
                                                        </button>
                                            ...
                                            {/* Countdown Style */}
                                            <div className="mb-3">
                                                <p className="mb-2 text-sm font-medium text-gray-700">Animasi Hitung Mundur:</p>
                                                <div className="flex justify-start gap-2">
                                                    <button
                                                        onClick={() => setCountdownStyle('bubble')}
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            countdownStyle === 'bubble' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        Gelembung
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            countdownStyle === 'flip' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        Flip
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            countdownStyle === 'bounce' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        Lompat
                                                    </button>
                                            ...
                                            {/* Filter options */}
                                            <div className="mb-3">
                                                <p className="mb-2 text-sm font-medium text-gray-700">Filter Foto:</p>
                                                <div className="flex justify-start gap-2">
                                                    <button
                                                        onClick={() => setCanvasFilter('normal')}
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            canvasFilter === 'normal' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        Normal
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            canvasFilter === 'sepia' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        Sepia
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            canvasFilter === 'grayscale' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        B&W
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`rounded-full px-3 py-1 text-xs ${
                                                            canvasFilter === 'invert' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-800'
                                                        }`}
                                                    >
                                                        Invert
                                                    </button>
...
Index.layout = (page: React.ReactNode) => <Layout children={page} title="Voting - PEMIRA" />;
